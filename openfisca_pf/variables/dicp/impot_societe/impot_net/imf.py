...
from openfisca_pf.enums.impot_societe.activity import (
    Activite,
    ACTIVITE_REDUCTION_IMF_ENCODEE,
    ACTIVITE_REDUCTION_TAUX_A_SAISIR_IMF_ENCODEE
    )
...
class imf_net_possede_reduction(Variable):
    ...
    def formula(personne: Population, period: Period, parameters: ParameterNode) -> ArrayLike:
        ...
        return isin(activite_principale, ACTIVITE_REDUCTION_IMF_ENCODEE)
...
class imf_net_reduction_taux_est_a_saisir(Variable):
    ...
    def formula(personne: Population, period: Period, parameters: ParameterNode) -> ArrayLike:
        activite_principale = personne('is_activite_principale', period, parameters)
        return isin(activite_principale, ACTIVITE_REDUCTION_TAUX_A_SAISIR_IMF_ENCODEE)
