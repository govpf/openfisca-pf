...
class montant_total_deductions_cstns(Variable):
    ...
    # def formula(personne, period, parameters):
    #     montant_acompte_cstns_1 = personne('montant_acompte_cstns_1', period)
    #     montant_acompte_cstns_2 = personne('montant_acompte_cstns_2', period)
    #     montant_declaration_provisoire_cstns = personne('montant_declaration_provisoire_cstns', period)
    #     montant_credcstns_impot_cstns_1 = personne('montant_credcstns_impot_cstns_1', period)
    #     montant_credcstns_impot_cstns_2 = personne('montant_credcstns_impot_cstns_2', period)
    #     montant_credcstns_impot_cstns_3 = personne('montant_credcstns_impot_cstns_3', period)
    #     montant_credcstns_impot_cstns_4 = personne('montant_credcstns_impot_cstns_4', period)
