...
class montant_majoration_cstns(Variable):
    ...
    def formula(entreprise, period, parameters):
        taux_majoration_cstns = entreprise('taux_majoration_cstns', period)
...
class montant_total_penalites_cstns(Variable):
    ...
    def formula(entreprise, period, parameters):
        montant_amendes_cstns = entreprise('montant_amendes_cstns', period)
        montant_majoration_cstns = entreprise('montant_majoration_cstns', period)
        montant_penalites_cstns = entreprise('montant_penalites_cstns', period)
