...
class montant_du_cstns_tranche_1(Variable):
    ...
    def formula(personne, period, parameters):
        tranche = 1
        cstns_prestations_tranche = personne(f'montant_cstns_prestations_du_tranche_{tranche}', period)
        cstns_ventes_tranche = personne(f'montant_cstns_ventes_du_tranche_{tranche}', period)
