...
class montant_it_ventes_du_tranche_1(Variable):
    ...
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 1 sans tenir compte de l'abattement de droits"
    reference = [
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_1 * taux_it_ventes_tranche_1)
...
class montant_it_ventes_du_tranche_2(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 2 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_2 * taux_it_ventes_tranche_2)
...
class montant_it_ventes_du_tranche_3(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 3 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_3 * taux_it_ventes_tranche_3)
...
class montant_it_ventes_du_tranche_4(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 4 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_4 * taux_it_ventes_tranche_4)
...
class montant_it_ventes_du_tranche_5(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 5 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_5 * taux_it_ventes_tranche_5)
...
class montant_it_ventes_du_tranche_6(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 6 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_6 * taux_it_ventes_tranche_6)
...
class montant_it_ventes_du_tranche_7(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 7 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_7 * taux_it_ventes_tranche_7)
...
class montant_it_ventes_du_tranche_8(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 8 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_8 * taux_it_ventes_tranche_8)
...
class montant_it_ventes_du_tranche_9(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 9 sans tenir compte de l'abattement de droits"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_9 * taux_it_ventes_tranche_9)


class montant_it_ventes_du_tranche_10(Variable):
    value_type = float
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 10 sans tenir compte de l'abattement de droits [simulation]"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_10 * taux_it_ventes_tranche_10)


class montant_it_ventes_du_tranche_11(Variable):
    value_type = float
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 11 sans tenir compte de l'abattement de droits [simulation]"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_11 * taux_it_ventes_tranche_11)


class montant_it_ventes_du_tranche_12(Variable):
    value_type = float
    entity = Personne
    definition_period = YEAR
    label = "Montant de l'impôt sur les transactions de ventes pour la tranche 12 sans tenir compte de l'abattement de droits [simulation]"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(personne: Personne, period: Period, parameters: Parameters) -> ArrayLike:
        ...
        return arrondi_inferrieur(base_imposable_it_ventes_tranche_12 * taux_it_ventes_tranche_12)
