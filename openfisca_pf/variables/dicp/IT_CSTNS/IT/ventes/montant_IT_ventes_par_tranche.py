...
class montant_it_ventes_du_tranche_1(Variable):
    ...
    def formula(personne, period, parameters):
        tranche = 1
        ca = personne(f'base_imposable_it_ventes_tranche_{tranche}', period)
        taux = personne.pays(f'taux_it_ventes_tranche_{tranche}', period)
...
class montant_it_ventes_du_tranche_10(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = u"Montant d'IT de la tranche 10 sur les ventes sans tenir compte de l'abattement de droits :\n\n#montant_it_ventes_du_tranche_10 = arrondiInf(#base_imposable_it_ventes_tranche_10 * #taux_it_ventes_tranche_10)"
    reference = ["https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot", "https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47"]  # Always use the most official source
...
class montant_it_ventes_du_tranche_11(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = u"Montant d'IT de la tranche 11 sur les ventes sans tenir compte de l'abattement de droits :\n\n#montant_it_ventes_du_tranche_11 = arrondiInf(#base_imposable_it_ventes_tranche_11 * #taux_it_ventes_tranche_11)"
    reference = ["https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot", "https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47"]  # Always use the most official source
...
class montant_it_ventes_du_tranche_12(Variable):
    ...
    entity = Personne
    definition_period = YEAR
    label = u"Montant d'IT de la tranche 12 sur les ventes sans tenir compte de l'abattement de droits :\n\n#montant_it_ventes_du_tranche_12 = arrondiInf(#base_imposable_it_ventes_tranche_12 * #taux_it_ventes_tranche_12)"
    reference = ["https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot", "https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47"]  # Always use the most official source
