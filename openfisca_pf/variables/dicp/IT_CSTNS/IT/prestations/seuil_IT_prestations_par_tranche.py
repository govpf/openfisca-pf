...
class seuil_it_prestations_tranche_1(Variable):
    ...
    label = "Seuil de tranche 1 de l'impôt sur les transactions de les ventes"
    reference = [
...
class seuil_it_prestations_tranche_2(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 2 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
...
class seuil_it_prestations_tranche_3(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 3 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
...
class seuil_it_prestations_tranche_4(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 4 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
...
class seuil_it_prestations_tranche_5(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 5 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
...
class seuil_it_prestations_tranche_6(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 6 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
...
class seuil_it_prestations_tranche_7(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 7 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(pays: Pays, period: Period, parameters: Parameters) -> ArrayLike:
        return parameters(period).dicp.it.taux_prestations.thresholds[6]
...
class seuil_it_prestations_tranche_8(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 8 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(pays: Pays, period: Period, parameters: Parameters) -> ArrayLike:
        return parameters(period).dicp.it.taux_prestations.thresholds[7]
...
class seuil_it_prestations_tranche_9(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 9 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(pays: Pays, period: Period, parameters: Parameters) -> ArrayLike:
        return parameters(period).dicp.it.taux_prestations.thresholds[8]
...
class seuil_it_prestations_tranche_10(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 10 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(pays: Pays, period: Period, parameters: Parameters) -> ArrayLike:
        return parameters(period).dicp.it.taux_prestations.thresholds[9]
...
class seuil_it_prestations_tranche_11(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 11 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(pays: Pays, period: Period, parameters: Parameters) -> ArrayLike:
        return parameters(period).dicp.it.taux_prestations.thresholds[10]
...
class seuil_it_prestations_tranche_12(Variable):
    ...
    entity = Pays
    definition_period = YEAR
    label = "Seuil de tranche 12 de l'impôt sur les transactions de les ventes"
    reference = [
        'https://www.impot-polynesie.gov.pf/code/40-section-iv-calcul-de-limpot',
        'https://www.impot-polynesie.gov.pf/sites/default/files/2018-03/20180315%20CDI%20v%20num%20SGG-DICP.pdf#page=47'
        ]
    ...
    def formula(pays: Pays, period: Period, parameters: Parameters) -> ArrayLike:
        return parameters(period).dicp.it.taux_prestations.thresholds[12]
