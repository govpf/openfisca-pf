...
class taux_it_prestations_tranche_3(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[2] if nombre_tranches_it_prestations > 2 else 0)
...
class taux_it_prestations_tranche_4(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[3] if nombre_tranches_it_prestations > 3 else 0)
...
class taux_it_prestations_tranche_5(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[4] if nombre_tranches_it_prestations > 4 else 0)
...
class taux_it_prestations_tranche_6(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[5] if nombre_tranches_it_prestations > 5 else 0)
...
class taux_it_prestations_tranche_7(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[6] if nombre_tranches_it_prestations > 6 else 0)
...
class taux_it_prestations_tranche_8(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[7] if nombre_tranches_it_prestations > 7 else 0)
...
class taux_it_prestations_tranche_9(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[8] if nombre_tranches_it_prestations > 8 else 0)
...
class taux_it_prestations_tranche_10(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[9] if nombre_tranches_it_prestations > 9 else 0)
...
class taux_it_prestations_tranche_11(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[10] if nombre_tranches_it_prestations > 10 else 0)
...
class taux_it_prestations_tranche_12(Variable):
    ...
    def formula(pays, period, parameters):
        nombre_tranches_it_prestations = pays(f'nombre_tranches_it_prestations', period)
        return (parameters(period).dicp.it.taux_prestations.rates[11] if nombre_tranches_it_prestations > 11 else 0)
