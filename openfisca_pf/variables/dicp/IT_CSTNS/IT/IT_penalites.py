...
class montant_total_penalites_it(Variable):
    ...
    def formula(entreprise, period, parameters):
        montant_amendes_it = entreprise('montant_amendes_it', period)
        montant_majoration_it = entreprise('montant_majoration_it', period)
        montant_penalites_it = entreprise('montant_penalites_it', period)
