...
class montant_du_it_tranche_1(Variable):
    ...
    def formula(personne, period, parameters):
        tranche = 1
        it_prestations_tranche = personne(f'montant_it_prestations_du_tranche_{tranche}', period)
        it_ventes_tranche = personne(f'montant_it_ventes_du_tranche_{tranche}', period)
