...
class TypesNatureEmprise(Enum):
    ...
    em_eco_05_emprise_maririme_general = u'EM-ECO-05 Emprise maritime ou terrestre (cas général)'
    em_eco_06_emprise_maritime_lucratif = u'EM-ECO-06 Emprise dédiée à une activité nautique lucrative'
    ...
    em_pr_05_emprise_maririme_general = u'EM-PR-05 Emprise maritime ou terrestre (cas général)'
