...
class montant_total_redevance_domaniale_type_23(Variable):
    ...
    def formula(personne, period, parameters):
        ...
        nature_emprise_occupation_redevance_domaniale = where(type_calcul == '23', nature_emprise_occupation_redevance_domaniale.decode_to_str(), 'ip_eco_06_infra_restauration_aero')
