...
class montant_redevance_domaniale_type_5(Variable):
    ...
    def formula(personne, period, parameters):
        ...
        tarif_horaire = parameters(period).daf.redevance_domaniale.type_11[nature_emprise_occupation_redevance_domaniale].tarif_horaire
        duree_demi_jour = parameters(period).daf.redevance_domaniale.type_11[nature_emprise_occupation_redevance_domaniale].duree_demi_jour
